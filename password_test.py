...
#user account
    ...
    def setUp(self): #first test, test to see if our objects are being instantiated correctly.
        ...
        '''
        self.new_user = User("Kevin","Jared","Kipkemoi","kipkemoi@2022") # create user object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.last_name,"Jared")
        self.assertEqual(self.new_user.username,"Kipkemoi")
        self.assertEqual(self.new_user.password,"kipkemoi@2022")
    ...
    def test_save_multiple_user(self): #third test
            ...
            '''
            self.new_user.save_user()
            test_user = User("Test","user","Kipkemoi","kipkemoi@2022") # new user
            test_user.save_user()
    ...
    def test_find_user_by_password(self): #fifth test
        ...
        self.new_user.save_user()
        test_user = User("Kevin","Jared","Kipkemoi","kipkemoi@2022") # new user
        test_user.save_user()

        find_user = User.find_by_password("kipkemoi@2022")
    ...
    def test_user_exists(self):
        ...
        user_exists = User.user_exist("Kipkemoi")
